...
open(FILE,"./jvrc_agreement_log/jvrc_agreement_Hydra_en.csv")||die "Can't open file";
flock(FILE,2);
@etr_log_body=<FILE>;
flock(FILE,8);
close(FILE);
