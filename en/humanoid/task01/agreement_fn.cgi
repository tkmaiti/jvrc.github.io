...
open(FILE,"./jvrc_agreement_log/jvrc_agreement_task01_en.csv")||die "Can't open file";
flock(FILE,2);
@etr_log_body=<FILE>;
flock(FILE,8);
close(FILE);
...
#	$printshozoku = " ■ Department/Company ■ $shozoku \n";
	...
	$subject = "Japan Virtual Robotics Challenge(JVRC) task model download";
