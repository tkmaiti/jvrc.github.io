...
open(FILE,"./jvrc_agreement_log/jvrc_agreement_JAXON_en.csv")||die "Can't open file";
flock(FILE,2);
@etr_log_body=<FILE>;
flock(FILE,8);
close(FILE);
...
#	$printshozoku = " ■ Department/Company ■ $shozoku \n";
	...
	$subject = "Japan Virtual Robotics Challenge(JVRC) JAXON robot model download";
...
<tr>
<th width="17%" nowrap="nowrap" class="t_top">E-mail address</th>
<td width="6%" class="aqua"><span class="f-12 TXT-ORG">optional</span></td>
