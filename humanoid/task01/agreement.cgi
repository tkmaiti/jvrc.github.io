...
<br />
<div class="need2">
<span class="red">以下の内容にお間違いがなければ【ダウンロードする】ボタンを押してください。</span>
</div>
...
<div class="t-center">
<form method="post" action="https://jvrc.org/humanoid/task01/agreement_fn.cgi" name="thisform" onsubmit='return checkForm()'>
<input type=button value=" 戻 る " onClick="javascript:history.back()">　<input type=submit value="ダウンロードする">
