...
$etr_log = "\"$date\",\"$ip\",\"$name\",\"$shozoku\",\"$mail\",,,,\n";

open(FILE,"./jvrc_agreement_log/jvrc_agreement_JAXON.csv")||die "Can't open file";
flock(FILE,2);
@etr_log_body=<FILE>;
flock(FILE,8);
close(FILE);
...
#	$printshozoku = " ■ご所属（勤務先）■ $shozoku \n";
	...
	$subject = "「ジャパンバーチャルロボティクスチャレンジ」JAXONロボットモデルダウンロード";
...
<meta http-equiv="Refresh" content="1;URL=./files/JAXON_MODEL.tar.gz">
...
-->
<tr>
<th width="17%" nowrap="nowrap" class="t_top">メールアドレス</th>
<td width="6%" class="aqua"><span class="f-12 TXT-ORG">任意</span><!--<div class="need">必須</div>--></td>
