...
open(FILE,"./jvrc_agreement_log/jvrc_agreement_JVRC-1.csv")||die "Can't open file";
flock(FILE,2);
@etr_log_body=<FILE>;
flock(FILE,8);
close(FILE);
...
#	$printshozoku = " ■ご所属（勤務先）■ $shozoku \n";
	...
	$subject = "「ジャパンバーチャルロボティクスチャレンジ」JVRC-1ロボットモデルダウンロード";
...
<meta http-equiv="Refresh" content="1;URL=./files/JVRC-1.zip">
