...
open(FILE,"./jvrc_agreement_log/jvrc_agreement_HRP-2-NEW.csv")||die "Can't open file";
flock(FILE,2);
@etr_log_body=<FILE>;
flock(FILE,8);
close(FILE);
...
$etr_log = "\"$count\",$date\",\"$ip\",\"$name\",\"$shozoku\",\"$mail\",,,,\n";
	...
	$printdate = " ■ ダウンロード\申\し込み日時 ■ $date \n";
	$printname = " ■     氏  名     ■ $name \n";
	$printshozoku = " ■ご所属（勤務先）■ $shozoku \n";
	$printmail = " ■ メールアドレス ■ $mail \n";


	$topbody = "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nジャパンバーチャルロボティクスチャレンジ(JVRC)\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nHRP-2改ロボットダウンロード\申\し込み、ありがとうございました。\n\n当ロボットモデルはロボットの製造元である川田工業（株）と秘密保持契約（NDA）を\n結んでいただく必要があります。NDAを締結するには法人である必要がありますのでご注意下さい。\n\n\n川田工業（株）との秘密保持契約（NDA）および、ダウンロードファイル取得までの流れ\n\n・川田工業様からのご連絡が行きますのでお待ちください。\n・川田工業様より連絡が来ましたら、川田工業様とNDA締結手続きをして下さい。\n・川田工業様とのNDA締結手続きが済みましたら、dl-request＠jvrc.org宛にご連絡下さい。\n・事務局よりロボットモデルダウンロードファイルをお送りいたします。\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n以下の内容が「ジャパンバーチャルロボティクスチャレンジ」事務局に送信されました。\n\n";
    $middlebody = "$printdate$printname$printshozoku$printmail\n\n";	
	$bottombody = "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n日　時：2015年（平成27年）10月7日～10月10日\n会　場：CEATEC JAPAN 2015\n参加費：無料\n\nジャパンバーチャルロボティクスチャレンジ事務局\nhttp://jvrc.org/\ndl-request\@jvrc.org\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n※入力された個人情報は、当大会のロボットモデルダウンロード\申\し込み以外では使用致しません。\n\　\送信はＳＳＬ（暗号化通信）で保護されています。";
	$send = "\"「Japan Virtual Robotics Challenge(JVRC)」事務局DL係\"<dl-request\@jvrc.org>";
	$subject = "「ジャパンバーチャルロボティクスチャレンジ」HRP-2改ロボットモデルダウンロード";
...
<br />
<b>川田工業（株）との秘密保持契約（NDA）および、ダウンロードファイル取得までの流れ<br /></b>
<br />

・お手元に、お\申\込み確認メールが届きますので、ご確認ください。<br />
・川田工業様からのご連絡が行きますのでお待ちください。<br />
・川田工業様より連絡が来ましたら、川田工業様とNDA締結手続きをして下さい。<br />
・川田工業様とのNDA締結手続きが済みましたら、dl-request＠jvrc.org宛にご連絡下さい。<br />
・事務局よりロボットモデルダウンロードファイルをお送りいたします。<br />
