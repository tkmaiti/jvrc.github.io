...
$etr_log = "\"$date\",\"$ip\",\"$name\",\"$kana\",\"$kinmu\",\"$yakushoku\",\"$yubin\",\"$todoufuken\",\"$jusho_1\",\"$jusho_2\",\"$tel\",\"$fax\",\"$mail\",,,,\n";
...
if($owFlag == 0){
	...
	$middlebody = "$printdate$printname$printkana$printkinmu$printyakushoku$printyubin$printtodoufuken$printjusho_1$printjusho_2$printtel$printfax$printmail\n\n";
