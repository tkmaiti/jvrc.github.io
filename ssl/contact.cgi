...
<br />
<div class="need2">
<span class="red">以下の内容にお間違いがなければ【お問合せを完了する】ボタンを押してください。</span>
</div>
...
<div class="t-center">
<form method="post" action="https://jvrc.org/ssl/contact_fn.cgi" name="thisform" onsubmit='return checkForm()'>
<input type=button value=" 戻 る " onClick="javascript:history.back()">　<input type=submit value="お問合せを完了する">
<input type=hidden name="name" value="$name">
<input type=hidden name="shozoku" value="$shozoku">
<input type=hidden name="mail" value="$mail">
<input type=hidden name="naiyo" value="$naiyo">									
